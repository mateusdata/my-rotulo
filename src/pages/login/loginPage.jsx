                ...
                <div className="mt-5">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid gap-y-4">
                      ...
                      <div>
                        <label for="CPF" className="block text-sm mb-2 dark:text-white">CPF </label>
                        <div className="relative">

                          <input {...register("cpf")}  className="py-3 px-4 block w-full border-gray-200 border focus:outline-blue-600 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"  aria-describedby="CPF-error" />
                      ...
                      <div>
                        <div className="flex justify-between items-center">
                          ...
                          {false && <a className="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="../examples/html/recover-account.html">Forgot senha?</a>}
                        </div>
                        <div className="relative">

                          <input  {...register("senha")}   type="senha" id="senha" name="senha" className="py-3 px-4 block w-full border-gray-200 border focus:outline-blue-600 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"  aria-describedby="senha-error" />
                      ...
                      <div className="flex items-center">
                        <div className="flex">
                          <input id="remember-me" name="remember-me" type="checkbox" className="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" />
                           <div className="ms-3">
                          <label for="remember-me" className="text-sm cursor-pointer dark:text-white">Lembrar senha</label>
                        </div>
                        </div>
