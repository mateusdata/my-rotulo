        ...
        <div className="max-w-2xl">
          ...
          <div className="space-y-5 md:space-y-8">
            <div className="space-y-3">
              ...
              <p className="text-lg text-gray-800 dark:text-gray-200">A plataforma web "O que é isso no meu rótulo?" é fruto de um projeto de pesquisa para divulgação científica que consiste em um buscador de interface simples, e que permite às pessoas consultarem informações sobre origem e função dos ingredientes informados em rótulos de produtos utilizados no cotidiano, tais com produtos alimentícios, higiene pessoal, cosméticos e saneantes. </p>
            </div>

            <p className="text-lg text-gray-800 dark:text-gray-200"> Estamos constantemente atualizando a base de dados com novos ingredientes para que nossa plataforma esteja cada vez mais completa e útil para a sociedade </p>
