      ...
      <div className="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
        <div className="max-w-2xl">
          ...
          <div className="space-y-5 md:space-y-8">
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-semibold dark:text-gray-800"> Qual a motivação? </h3>
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-semibold dark:text-gray-800">    O projeto </h3>
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-semibold dark:text-gray-800"> Agradecimentos:
              </h3>

              <div className="text-lg text-gray-800 dark:text-gray-800">
            <p>
