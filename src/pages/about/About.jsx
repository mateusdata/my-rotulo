  ...
  <div className="max-w-2xl">
    ...
    <div className="space-y-5 md:space-y-8">
      <div className="space-y-3">
        <h2 className="text-2xl font-bold md:text-3xl dark:text-white">O que é isso no meu rótulo? projeto de pesquisa</h2>

        <p className="text-lg text-gray-800 dark:text-gray-200">Este projeto visa criar um sistema web gratuito para ajudar as pessoas a entender os ingredientes nos rótulos de produtos alimentícios, corporais e de saneamento. A ideia é oferecer uma plataforma de divulgação científica acessível e fácil de usar, já que a linguagem técnica nos rótulos muitas vezes não é compreendida.</p>
      </div>
