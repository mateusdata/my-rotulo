...
function GlobalLayoutAdm({ children }) {
  ...
  return (
    <>
      <body class="bg-gray-10  flex min-h-screen w-full">
        <div class=" w-full flex flex-col mx-auto size-full">

          <header class="mb-2 fixed bg-green-500  flex flex-wrap sm:justify-start sm:flex-nowrap border-b  border-b-gray-300 z-50 w-full text-sm py-1">
            <nav class="w-full  px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
              <div class="flex items-center justify-between">
                {nomeUser ? <a class="flex-none text-xl font-semibold   focus:ring- hidden sm:block" href="#" aria-label="Brand">
                ...
                <a class="flex-none text-xl font-semibold  text-gray-50 focus:outline-none focus:ring-1 focus:ring-gray-600 sm:hidden" href="#" aria-label="Brand">{`${nomeUser ? nomeUser : "Meu rótulo"}`}</a>
              ...
              <div id="navbar-collapse-with-animation" class={`hs-collapse ${!showMenu && "hidden"} overflow-hidden transition-all duration-300 basis-full grow sm:block`}>
                {!nomeUser ? <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                  ...
                  <Link to={"/"} onClick={() => setCurrentPage(1)} class={`font-medium text-xl ${currentPage === 1 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`} aria-current="page">home</Link>
                  <Link to={"/sobre"} onClick={() => setCurrentPage(2)} class={`font-medium text-xl ${currentPage === 2 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`}>sobre</Link>
                  <Link to={"/contato"} onClick={() => setCurrentPage(3)} class={`font-medium text-xl ${currentPage === 3 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`}>contato</Link>
                </div>
                  :
                  <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">

                    <Link to={"/adm"} onClick={() => setCurrentPage(1)} class={`font-medium text-xl ${currentPage === 1 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`}>cadastro</Link>
                    <Link to={"/edit"} onClick={() => setCurrentPage(2)} class={`font-medium text-xl ${currentPage === 2 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`}>substancias</Link>
                    <Link to={"/"} onClick={() => setCurrentPage(3)} class={`font-medium text-xl ${currentPage === 3 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`} aria-current="page">home</Link>
                    <Link to={"/login"} onClick={() => {
                      logout();
                      setCurrentPage(1)
                    }} class={`font-medium text-xl ${currentPage === 3 ? "text-gray-800 hover:text-gray-900 " : "text-gray-50 hover:text-gray-900"} sm:py-3  hover:text-gray-400`} aria-current="page">sair</Link>
...
export default GlobalLayoutAdm;
